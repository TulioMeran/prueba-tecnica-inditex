...
const PodCastItem: FC<PodCastItemProps> = ({ img, author, title }) => {

    return (
        <Paper elevation={3} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginBottom: 10, width: 300, marginX: 2 }} >
